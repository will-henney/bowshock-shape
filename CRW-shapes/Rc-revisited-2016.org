...
* TODO [5/5] Joining the head and tail conics
:PROPERTIES:
...
#+BEGIN_SRC sh :results file
python conic-head-tail.py -0.75
#+END_SRC
...
#+BEGIN_SRC sh :results file
python conic-head-tail.py -0.75 1.0
#+END_SRC
...
#+BEGIN_SRC sh :results file
python conic-head-tail.py 0.1 0.4
#+END_SRC
...
** Testing the gradient calculation for CRW shapes at th=90
