...
* TODO [1/4] Joining the head and tail conics
+ Revisiting this after summer break [2016-08-23 Tue]
+ [X] Seems to be working for CRW case, so log as head quadric is hyperbola
+ [ ] Need to track down error for when head quadric is ellipse
+ [ ] And need to find \(\phi_{}_{}_{}_{}_{}_{}_{}_{1}/\phi_{}\) for the general-k case
+ [ ] Finally, we need to look at using alternative join points
