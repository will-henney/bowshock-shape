  ...
  for k, color in zip(ks, colors):
      for beta in betas:
          ...
          if k is None:
              ...
              xi = 2.0 / (k + 2.0)
              R = ancantoid_shape.Ancantoid(xi=xi, beta=beta, n=301)
...
#+BEGIN_SRC sh :results file
python crw-departure.py 0
#+END_SRC

#+RESULTS:
[[file:crw-departure-00.pdf]]

#+BEGIN_SRC sh :results file
python crw-departure.py 0.5
#+END_SRC

#+RESULTS:
[[file:crw-departure-05.pdf]]

#+BEGIN_SRC sh :results file
python crw-departure.py 3
#+END_SRC

#+RESULTS:
[[file:crw-departure-30.pdf]]
