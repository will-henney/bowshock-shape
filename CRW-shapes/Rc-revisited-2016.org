...
+ According to my new attempt at the small angle expansion we have
  ...
  + \[c = \frac{1}{30} \left(1 - \beta - \frac34 k\right)\]
+ I still suspect this may not be quite right, perhaps the equation for \(c\) since I am pretty sure about the first one now
  + Empirically, it seems that the coefficient of k should be 9/4, not 3/4
