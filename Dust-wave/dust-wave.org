...
+ So, for MS20 model
  ...
  + => G = 200 5 (0.64 + 0.16) R_pc^-2 = 800 R_pc^-2
  + G T^{1/2}/n = 8e4 R_pc^-2 n^-1 if we ignore extinction
  + So with n = 1pcc at R = 0.1 pc, we have 8e6
    + Fig 10 of WD at  G T^{1/2}/n = 1e6 gives U = 5 V for silicate and 8 V for graphite 
    + dustrad-n00-MS20 gives about the same at 0.1 pc
    + But at 1 pc grains are negative, despite still having G/n = 800
    + dustrad-n04-MS20 at 0.001 pc should have charging param = 8e6
