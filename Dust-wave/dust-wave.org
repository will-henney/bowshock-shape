...
+ Run in shell for theta = 05, 15, 30, 45, 60, 75
...
***** [4/4] Figures of the view angle grids
+ [X] Basic images
...
#+BEGIN_SRC sh :results file
python dust-lorentz-stream.py 15.0 5.0 
#+END_SRC

#+RESULTS:
[[file:dust-lorentz-stream-b15-L0500.jpg]]
