...
#+BEGIN_SRC python :eval no :tangle wilkinoid-R90-vs-Rc-wave.py
  import sys
  import numpy as np
  from matplotlib import pyplot as plt
  import matplotlib.ticker
...
#+BEGIN_SRC sh :results file
python wilkinoid-R90-vs-Rc-wave.py 0.1 1.5
#+END_SRC

#+RESULTS:
[[file:wilkinoid-R90-vs-Rc-wave-A010-N15.pdf]]

#+BEGIN_SRC sh :results file
python wilkinoid-R90-vs-Rc-wave.py 0.05 2.5
#+END_SRC

#+RESULTS:
[[file:wilkinoid-R90-vs-Rc-wave-A005-N25.pdf]]

#+BEGIN_SRC sh :results file
python wilkinoid-R90-vs-Rc-wave.py 0.15 0.7
#+END_SRC

#+RESULTS:
[[file:wilkinoid-R90-vs-Rc-wave-A015-N07.pdf]]
