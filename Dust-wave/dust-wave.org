...
|     |    |  Teff |     M | log L |  Mdot |    V |   Lw |      eta |
|-----+----+-------+-------+-------+-------+------+------+----------|
| T30 | B0 | 30000 | 14.73 |  4.39 |   210 | 3650 |  2.3 |   0.0154 |
| T28 |    | 28000 | 12.69 |  4.20 |   160 | 4380 |  2.5 |   0.0219 |
| T26 | B1 | 26000 | 10.88 |  3.99 |    96 | 3070 |  0.7 |   0.0149 |
| T24 |    | 24000 |  9.26 |  3.77 |    39 | 1700 | 9e-2 |   0.0056 |
| T22 |    | 22000 |  7.84 |  3.54 |   7.9 | 1690 | 2e-2 |   0.0019 |
| T20 |    | 20000 |  6.60 |  3.30 |   3.4 | 1290 | 5e-3 |   0.0011 |
| T18 |    | 18000 |  5.52 |  3.03 |  0.91 |  820 | 5e-4 |   0.0003 |
| T16 | B5 | 16000 |  4.58 |  2.75 | 0.072 |  240 | 3e-6 | 1.520e-5 |
| T14 | B6 | 14000 |  3.76 |  2.43 |     0 |    0 |  0.0 |   0.0000 |
#+TBLFM: $8=$6 1e-11 $Msun ($7 $km)**2 / 2 $yr $Lsun ; f1::$9=$6 1e-11 $Msun $7 $km $c / $yr $Lsun 10**$5; f4
...
+ First with the high T_eff formula and Vw = 2.6 Vesc
  |     |    |  Teff |     M | log L |  Gamma | Vesc | 2.6 Vesc |   Mdot |     Lw |      eta |
  |-----+----+-------+-------+-------+--------+------+----------+--------+--------+----------|
  | T30 | B0 | 30000 | 14.73 |  4.39 | 0.0382 | 965. |    2509. |  -8.06 |   4.52 |   0.0440 |
  | T28 |    | 28000 | 12.69 |  4.20 | 0.0286 | 938. |    2439. |  -8.51 |   1.52 |   0.0235 |
  | T26 | B1 | 26000 | 10.88 |  3.99 | 0.0206 | 913. |    2374. |  -9.03 |   0.43 |   0.0112 |
  | T24 |    | 24000 |  9.26 |  3.77 | 0.0146 | 886. |    2304. |  -9.61 |   0.11 |   0.0048 |
  | T22 |    | 22000 |  7.84 |  3.54 | 0.0101 | 855. |    2223. | -10.25 |   0.02 |   0.0018 |
  | T20 |    | 20000 |  6.60 |  3.30 | 0.0069 | 820. |    2132. | -10.98 | 3.9e-3 |   0.0006 |
  | T18 |    | 18000 |  5.52 |  3.03 | 0.0044 | 789. |    2051. | -11.83 | 5.1e-4 |   0.0001 |
  | T16 | B5 | 16000 |  4.58 |  2.75 | 0.0028 | 751. |    1953. | -12.80 | 5.0e-5 | 2.723e-5 |
  | T14 | B6 | 14000 |  3.76 |  2.43 | 0.0016 | 717. |    1864. | -13.99 | 2.9e-6 | 3.505e-6 |
  #+TBLFM: $6=(10**$5 / $4) / 43640 ; f4::$7=1070 ($3/1e4) ($4*(1 - $6))**0.5 / 10**($5/4) ; f0::$8=2.6 $-1 ;f0::$9=-6.697 + 2.195 ($5 - 5) - 1.313 log10($4/30) - 1.226 log10(2.6/2) + 0.933 log10($3/40000) - 10.92 (log10($3/40000))**2 ; f2::$10=10**$-1 $Msun ($-2 $km)**2 / 2 $yr $Lsun ;f2::$11=10**$9 $Msun $8 $km $c / $yr 10**$5 $Lsun ; f4
+ Second, with the low T_eff formula and Vw = 1.3 Vesc
  |     |    |  Teff |     M | log L |  Gamma | Vesc | 1.3 Vesc |   Mdot |     Lw |    eta | Tjump |
  |-----+----+-------+-------+-------+--------+------+----------+--------+--------+--------+-------|
  | T30 | B0 | 30000 | 14.73 |  4.39 | 0.0382 | 965. |    1255. |  -7.13 |   9.63 | 0.1875 |  22.9 |
  | T28 |    | 28000 | 12.69 |  4.20 | 0.0286 | 938. |    1219. |  -7.50 |   3.88 | 0.1203 |  22.8 |
  | T26 | B1 | 26000 | 10.88 |  3.99 | 0.0206 | 913. |    1187. |  -7.91 |   1.43 | 0.0739 |  22.8 |
  | T24 |    | 24000 |  9.26 |  3.77 | 0.0146 | 886. |    1152. |  -8.34 |   0.50 | 0.0442 |  22.7 |
  | T22 |    | 22000 |  7.84 |  3.54 | 0.0101 | 855. |    1112. |  -8.79 |   0.17 | 0.0257 |  22.7 |
  | T20 |    | 20000 |  6.60 |  3.30 | 0.0069 | 820. |    1066. |  -9.26 |   0.05 | 0.0145 |  22.7 |
  | T18 |    | 18000 |  5.52 |  3.03 | 0.0044 | 789. |    1026. |  -9.81 |   0.01 | 0.0073 |  22.6 |
  | T16 | B5 | 16000 |  4.58 |  2.75 | 0.0028 | 751. |     976. | -10.37 | 3.4e-3 | 0.0037 |  22.6 |
  | T14 | B6 | 14000 |  3.76 |  2.43 | 0.0016 | 717. |     932. | -11.03 | 6.7e-4 | 0.0016 |  22.6 |
  #+TBLFM: $6=(10**$5 / $4) / 43640 ; f4::$7=1070 ($3/1e4) ($4*(1 - $6))**0.5 / 10**($5/4) ; f0::$8=1.3 $-1 ;f0::$9=-6.688 + 2.210 ($5 - 5) - 1.339 log10($4/30) - 1.601 log10(1.3/2) + 1.077 log10($3/20000) ; f2::$10=10**$9 $Msun ($8 $km)**2 / 2 $yr $Lsun ;f2::$11=10**$9 $Msun $8 $km $c / $yr 10**$5 $Lsun ; f4::$12=61.2 +2.59 (-14.9 + 3.2 $6) ;f1
...
|-------+------+-------+--------+------+-------+--------|
| 30000 | 12.9 |  4.50 | 1.0e-8 | 2440 |   4.9 | 0.0382 |
| 32500 | 16.4 |  4.74 | 1.4e-8 | 1900 |   4.2 | 0.0239 |
| 35000 | 20.9 |  4.97 | 3.8e-8 | 1220 |   4.7 | 0.0246 |
| 37500 | 26.8 |  5.19 | 1.1e-7 | 1770 |  28.4 | 0.0622 |
| 40000 | 34.6 |  5.42 | 2.5e-7 | 1960 |  79.2 | 0.0921 |
| 42500 | 45.0 |  5.64 | 4.5e-7 | 1910 | 135.4 | 0.0974 |
#+TBLFM: $6=$4 $Msun ($5 $km)**2 / 2 $yr $Lsun ; f1::$7=$4 $Msun $5 $km $c / $yr $Lsun 10**$3; f4

Giants
|     T |    M | log L |   Mdot |   Vw |    Lw |    eta |
|-------+------+-------+--------+------+-------+--------|
| 30000 | 19.3 |  5.10 | 6.2e-8 | 2070 |  21.9 | 0.0504 |
| 32500 | 22.8 |  5.25 | 1.2e-7 | 1470 |  21.4 | 0.0491 |
| 35000 | 27.2 |  5.41 | 2.4e-7 | 1200 |  28.5 | 0.0554 |
| 37500 | 32.5 |  5.57 | 4.2e-7 | 1620 |  90.9 | 0.0906 |
| 40000 | 39.2 |  5.71 | 9.3e-7 | 1320 | 133.7 | 0.1184 |
| 42500 | 47.4 |  5.85 | 1.5e-6 | 1200 | 178.2 | 0.1258 |
#+TBLFM: $6=$4 $Msun ($5 $km)**2 / 2 $yr $Lsun ; f1::$7=$4 $Msun $5 $km $c / $yr $Lsun 10**$3; f4

Supergiants
|     T |    M | log L |   Mdot |   Vw |    Lw |    eta |
|-------+------+-------+--------+------+-------+--------|
| 30000 | 28.8 |  5.56 | 4.5e-7 | 1110 |  45.7 | 0.0680 |
| 32500 | 34.0 |  5.66 | 5.7e-7 | 1140 |  61.1 | 0.0703 |
| 35000 | 40.4 |  5.75 | 6.9e-7 | 1350 | 103.7 | 0.0819 |
| 37500 | 48.3 |  5.84 | 1.2e-6 | 1260 | 157.2 | 0.1081 |
| 40000 | 58.1 |  5.92 | 1.4e-6 | 1460 | 246.2 | 0.1216 |
| 42500 | 70.3 |  6.00 | 1.8e-6 | 1350 | 270.6 | 0.1202 |
#+TBLFM: $6=$4 $Msun ($5 $km)**2 / 2 $yr $Lsun ; f1::$7=$4 $Msun $5 $km $c / $yr $Lsun 10**$3; f4
...
|     T |    M | log L |   Mdot |   Vw |    Lw |    eta |
|-------+------+-------+--------+------+-------+--------|
| 30000 | 12.9 |  4.50 | 1.3e-8 | 2440 |   6.4 | 0.0496 |
| 32500 | 16.4 |  4.74 | 4.2e-8 | 1900 |  12.5 | 0.0718 |
| 35000 | 20.9 |  4.97 | 1.2e-7 | 1220 |  14.7 | 0.0776 |
| 37500 | 26.8 |  5.19 |   3e-7 | 1770 |  77.5 | 0.1696 |
| 40000 | 34.6 |  5.42 | 7.3e-7 | 1960 | 231.4 | 0.2691 |
| 42500 | 45.0 |  5.64 | 1.6e-6 | 1910 | 481.5 | 0.3463 |
#+TBLFM: $6=$4 $Msun ($5 $km)**2 / 2 $yr $Lsun ; f1::$7=$4 $Msun $5 $km $c / $yr $Lsun 10**$3; f4

Giants
|     T |    M | log L |   Mdot |   Vw |    Lw |    eta |
|-------+------+-------+--------+------+-------+--------|
| 30000 | 19.3 |  5.10 | 1.6e-7 | 2070 |  56.6 | 0.1301 |
| 32500 | 22.8 |  5.25 | 3.7e-7 | 1470 |  66.0 | 0.1513 |
| 35000 | 27.2 |  5.41 | 8.0e-7 | 1200 |  95.0 | 0.1847 |
| 37500 | 32.5 |  5.57 | 1.5e-6 | 1620 | 324.8 | 0.3235 |
| 40000 | 39.2 |  5.71 | 2.7e-6 | 1320 | 388.1 | 0.3437 |
| 42500 | 47.4 |  5.85 | 4.5e-6 | 1200 | 534.6 | 0.3773 |
#+TBLFM: $6=$4 $Msun ($5 $km)**2 / 2 $yr $Lsun ; f1::$7=$4 $Msun $5 $km $c / $yr $Lsun 10**$3; f4

Supergiants
|     T |    M | log L |   Mdot |   Vw |    Lw |    eta |
|-------+------+-------+--------+------+-------+--------|
| 30000 | 28.8 |  5.56 | 9.9e-7 | 1110 | 100.6 | 0.1497 |
| 32500 | 34.0 |  5.66 | 1.7e-6 | 1140 | 182.3 | 0.2097 |
| 35000 | 40.4 |  5.75 | 2.6e-6 | 1350 | 390.9 | 0.3087 |
| 37500 | 48.3 |  5.84 | 3.7e-6 | 1260 | 484.6 | 0.3333 |
| 40000 | 58.1 |  5.92 | 4.7e-6 | 1460 | 826.5 | 0.4081 |
| 42500 | 70.3 |  6.00 | 5.6e-6 | 1350 | 842.0 | 0.3739 |
#+TBLFM: $6=$4 $Msun ($5 $km)**2 / 2 $yr $Lsun ; f1::$7=$4 $Msun $5 $km $c / $yr $Lsun 10**$3; f4
...
|      |     T | log L |     R |     M |  Gamma |  Vesc | 2.6 Vesc |  Mdot |     Lw |    eta |
|------+-------+-------+-------+-------+--------+-------+----------+-------+--------+--------|
