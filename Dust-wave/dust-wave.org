...
#+BEGIN_SRC sh :results output
  FIGFILES="dust-couple-stream-annotate.pdf dust-wave-Rc-R90*.pdf dust-coupling-1d.pdf dust-divergent.pdf dust-couple-div-stream.jpg decouple-v-n-plane.pdf zones-v-n-plane.pdf zones-v-n-plane-?SG.pdf decouple-v40-versus-n.pdf multi-view-dust-bfield-?5.pdf dust-bfield-stream-b?5-z0000.jpg"
  date
  pwd
...
#+BEGIN_SRC sh :results file
python dust-lorentz-stream-3d-turb.py 0.0 10.0 50.0 0.0
#+END_SRC

#+RESULTS:
[[file:dust-lorentz-stream-3d-turb-b00-L1000-Ma0500-Z+000.jpg]]
...
#+RESULTS:
[[file:dust-lorentz-stream-3d-turb-b75-L1000-Ma0100.jpg]]
