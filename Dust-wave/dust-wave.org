...
#+BEGIN_SRC sh :results output
  FIGFILES='dust-couple-stream-annotate.pdf dust-wave-Rc-R90*.pdf dust-coupling-1d.pdf dust-divergent.pdf'
  date
  pwd
...
** TODO Diverging stream trajectories
:LOGBOOK:
