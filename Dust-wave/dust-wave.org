...
+ [3/9] Plan of work for ~bow_projection.py~ and its applications
  ...
  4. [-] Implement numerical R(\theta) functions: ancantoid, dragoid
     ...
     + [ ] Solve the problems I have at \theta = 0 and \theta \to 180
     + [ ] Use equation6.py or similar for the ancantoid
...
*** Test of spline fit plane-of-sky shapes
