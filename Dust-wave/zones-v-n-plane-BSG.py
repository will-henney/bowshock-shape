...
fig, axes = plt.subplots(1, 1, sharex=True, sharey=True, figsize=(3, 4))
stardata = [
...
d = {
    "RBW y": {33.0: 4000.0, 20.0: 5000.0, 40.0: 2500.0},
    "trapped y": {33.0: 3.5e4, 20.0: 2.5e5, 40.0: 1.5e5},
    "trapped bg": {33.0: '0.85', 20.0: 'w', 40.0: 'w'},
