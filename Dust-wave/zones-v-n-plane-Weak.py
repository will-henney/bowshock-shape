...
d = {
    "RBW y": {33.0: 1500.0, 20.0: 200.0, 40.0: 2500.0},
...
for M, L4, eta, S49, ax in stardata:
    ...
    ax.text(18.0, 1.5e-3, Mlabel, zorder=100, fontsize='x-small', bbox=box_params)
    ax.text(18.0, 1e3, RBW_label, rotation=15, fontsize='xx-small', bbox={**box_params, **dict(fc='0.85', ec='0.6')})
    ax.text(16.0, 1e6, RBS_label, rotation=15, fontsize='xx-small', bbox=box_params)
    ax.text(20.0, 1.0, WBS_label, rotation=15, fontsize='xx-small', bbox=box_params)
