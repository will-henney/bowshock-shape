...
TRSG=[["alphaori", "3.70", "1.43", "1.38", "1.43"], ["uuaur", "0.78", "1.31", "1.22", "1.39"], ["rleo", "0.85", "1.43", "1.29", "1.39"], ["rhya", "0.89", "1.48", "1.46", "1.69"], ["v1943sgr", "0.53", "1.34", "1.42", "1.20"], ["xpav", "0.48", "1.51", "1.48", "1.50"], ["mucep", "0.70", "1.56", "1.52", "1.26"]]
import sys
import numpy as np
