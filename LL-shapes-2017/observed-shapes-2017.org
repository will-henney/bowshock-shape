...
+ Results using |\theta_c| < 30\deg:
  ...
  |---------+-----------------+-----------------+-----------------|
  |         | 2.965 +/- 0.328 | 2.888 +/- 0.197 | 2.258 +/- 0.100 |
  #+TBLFM: @6$2..@6$4=vmeane(@I..@II);f3
  - There are two entries for the Ridge because the iteration converges on a limit cycle between 2 points, rather than a single point
...
+ Results using |\theta_c| < 45\deg:
  | Curve |               \Pi |              \Lambda- |              \Lambda+ |
  |-------+-----------------+-----------------+-----------------|
  | Inner |           2.702 |           2.518 |           2.111 |
  | Ridge |           4.441 |           2.950 |           2.846 |
  | Outer |           3.111 |           2.460 |           2.582 |
  |-------+-----------------+-----------------+-----------------|
  |       | 3.418 +/- 0.525 | 2.643 +/- 0.155 | 2.513 +/- 0.215 |
  #+TBLFM: @5$2..@5$4=vmeane(@I..@II);f3
  - This time, all of the arcs converge in 3 or 4 iterations
+ Results using |\theta_c| < 25\deg:
  | Curve   |               \Pi |              \Lambda- |              \Lambda+ |
  |---------+-----------------+-----------------+-----------------|
