...
** Turns out that it should have been 069-601

#+BEGIN_SRC python :return plotfile :results output
  import sys 
  ...
  for arc in "inner", "outer", "ridge":
      for delta_theta in 45, 50, 55, 60, 65, 70, 75, 80:
          ...
          circle_fit.plot_solution(
              ...
              plotfile,
              delta_theta=delta_theta, vmin=6.2, vmax=8.1)
#+END_SRC
...
CircleFit(Planitude = 7.560999815905771, Alatude = [ 3.68310991  3.42091275])
...
CircleFit(Planitude = 7.560999815905771, Alatude = [ 3.68310991  3.42091275])
CircleFit(Planitude = 4.2094889097496795, Alatude = [ 3.29870311  2.50149778])
CircleFit(Planitude = 4.2094889097496795, Alatude = [ 3.29870311  2.50149778])
CircleFit(Planitude = 4.2094889097496795, Alatude = [ 3.29870311  2.50149778])
#### #### #### #### #### #### #### #### #### #### 
...
CircleFit(Planitude = 7.560999815905771, Alatude = [ 3.68310991  3.42091275])
CircleFit(Planitude = 4.2094889097496795, Alatude = [ 3.29870311  2.50149778])
CircleFit(Planitude = 3.7288483913636323, Alatude = [ 3.36985629  2.43507017])
CircleFit(Planitude = 3.7288483913636323, Alatude = [ 3.36985629  2.43507017])
#### #### #### #### #### #### #### #### #### #### 
...
CircleFit(Planitude = 7.560999815905771, Alatude = [ 3.68310991  3.42091275])
CircleFit(Planitude = 3.371937008212076, Alatude = [ 3.30682456  2.43364032])
CircleFit(Planitude = 3.7288483913636323, Alatude = [ 3.36985629  2.43507017])
CircleFit(Planitude = 3.7288483913636323, Alatude = [ 3.36985629  2.43507017])
#### #### #### #### #### #### #### #### #### #### 
...
FILES="000-400-planitude-alatude.pdf 000-400-Pi-vs-Dtheta.pdf"
date
cp -v $FILES ../papers/Papers1234/figs
#+END_SRC

#+RESULTS:
: Tue Feb 27 10:50:00 CST 2018
