...
#+BEGIN_SRC sh :results verbatim
  D=../read-shapes-LL
  python $D/find-xy-shell.py M16-MS2070n00p10-CD --pa0 0 --window 9
...
[[Variables]]
    xc:   0.33132693 +/- 0.328603 (99.18%) (init= 1.654683)
    yc:  -90.3086757 +/- 2.550880 (2.82%) (init=-129.5469)
[[Correlations]] (unreported correlations are <  0.100)
    C(xc, yc)                    =  0.109 
outer : 0.331326935361 -90.3086757514 219.628141348
#+end_example
...
#+BEGIN_SRC sh :results verbatim
  D=../read-shapes-LL
  python $D/find-xy-shell.py M16-MS2070n00p10-BS --pa0 0 --window 9
