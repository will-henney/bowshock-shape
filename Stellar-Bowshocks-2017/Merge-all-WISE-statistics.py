...
for circle in circle_variants:
    tab = Table.read(
        f"wise-arcfit-0{circle}_peak.tab",
        format='ascii.tab',
    )
...
# It is interesting that the two breadth measurements are not very well correlated. 
...
dfp.to_csv("wise-arcfit-peak-variants.tab", sep="\t")
