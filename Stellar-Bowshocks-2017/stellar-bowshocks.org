...
#+BEGIN_SRC python :eval no :tangle mipsgal-trace-arc.py
  ...
  for source_data in source_table[:100]:
      ...
      points2fit = np.concatenate((rpeak_coords[cmask_peak],  rmean_coords[cmask_mean]))                                         
      ...
      circ_offset_frame = center.skyoffset_frame(rotation=pa0)

      PA_circ = center.position_angle(c)
