...
#+name: combine-arcfit-results
#+BEGIN_SRC python :results file :return combo_file :var SUFF="060_both"
  import os
  import sys
  import glob
  ...
  IMAGE_DIR = f'OB/MipsGal/circ_theta_{SUFF}'

  NCOLUMNS = 24                   # What it *should* be
  list_of_rows = []
  ...
  combo_file = f'mipsgal-arcfit-{SUFF}.tab'
  combo_table.write(combo_file, format='ascii.tab', overwrite=True)
#+END_SRC

#+RESULTS: combine-arcfit-results
[[file:mipsgal-arcfit-060_both.tab]]



#+call: combine-arcfit-results(SUFF="070_both")

#+RESULTS:
[[file:mipsgal-arcfit-070_both.tab]]

#+call: combine-arcfit-results(SUFF="050_both")

#+RESULTS:
[[file:mipsgal-arcfit-050_both.tab]]
...
**** Combining all the fit variants
