...
#+BEGIN_SRC sh :results output
  FIGFILES='mipsgal-r0-r0.pdf mipsgal-Rc-R90-zoom.pdf mipsgal-Rc-R90-thumbnails.pdf mipsgal-pairplot.pdf mipsgal-Rc-R90-Mag.pdf mipsgal-Rc-R90-R0.pdf mipsgal-Rc-R90-candidates.pdf mipsgal-Rc-R90-environment.pdf mipsgal-Rc-R90-vs-Orion.pdf'
  date
  pwd
...
#+BEGIN_SRC python :return figfile :results file
  ...
  ax.plot(tab['Rc'][m5], tab['R90'][m5], 
          'o', ms=4, alpha=0.8, c='purple', label='MIPSGAL arcs')
  ax.plot(otab['Rc out'], otab['R90'], 
          'o', ms=7, alpha=0.8, c='c', label='M42 arcs')
  ...
  with sns.plotting_context(
      ...
      for data, c, axx in zip(datasets, colors, [ax_y_Rc, ax_n_Rc]):
          sns.distplot(data, bins=8, hist_kws={'range': [0.0, Rmax]},
                       color=c, kde=False, ax=axx)
