...
+ [ ] Improvements to make [2017-03-09 Thu]
  + Add a vector to image to show nominal axis PA
  + Indicate which cases have doubt about the central star
  + Use the =OVERRIDE= dict for sources with bad data
  + Try taking a longer step-back distance (maybe twice R0)
  + Add the \pm90 vertical lines to the graphs
