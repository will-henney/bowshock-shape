...
+ Two possible approaches:
  ...
  2. Use a more sophisticated method, such as:
     ...
     - [X] Something from sklearn, probably overkill
       ...
       - Turns out that statsmodels is better for that, but that doesn't cope on errors in x
     - [ ] A really sophisticated method is ~linmix~
       ...
       - I am running it now in a jupyter notebook, but it is taking forever
