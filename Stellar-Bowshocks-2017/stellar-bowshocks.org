...
#+BEGIN_SRC python :results file :return figfile
  ...
  fig, axes = plt.subplots(3, 1, sharex=True, figsize=(3, 5))
...
#+BEGIN_SRC python :results file :return figfile
  ...
  axes[0].set(ylabel=r'$R_{90} / R_{0}$')
  axes[1].set(ylabel=r'$R_{c} / R_{0}$', ylim=[None, 5.0])
  axes[2].set(ylabel=r'$H_0$, mag', ylim=[4.5, 13.9])
...
#+BEGIN_SRC sh :results output
  FIGFILES='mipsgal-r0-r0-plus-dPA-edited.pdf mipsgal-Rc-R90-zoom-annotated.pdf mipsgal-Rc-R90-thumbnails.pdf mipsgal-pairplot.pdf mipsgal-Rc-R90-Mag.pdf mipsgal-Rc-R90-R0.pdf mipsgal-Rc-R90-candidates.pdf mipsgal-Rc-R90-environment.pdf mipsgal-Rc-R90-vs-Orion.pdf mipsgal-Rc-R90-vs-Herschel.pdf p-value-histogram.pdf mipsgal-boxplot-Rc-R90-versus-R0.pdf mipsgal-boxplot-Rc-R90-versus-H0.pdf'
  date
  pwd
