...
+ Use =seaborn.pairplot(kind='reg')= to make a grid of regression plots
...
#+BEGIN_SRC python :return figfile :results file
  ...
  plotvars = ['log10 R0', 'log10 |b|', 'cos(l)', 'Hmag', '4.5mag', 'Ak']
  ...
  g = sns.PairGrid(df, vars=plotvars, size=1.5)
  g = g.map_upper(plt.scatter, marker='.', alpha=0.2, color='r')
  g = g.map_lower(sns.kdeplot, cmap="Blues_d", n_levels=10)
