...
#+BEGIN_SRC python :results file :return combo_file
  ...
  combo_table = join(source_table, fit_table, join_type='outer')

  combo_file = 'mipsgal-arcfit.tab'
  combo_table.write(combo_file, format='ascii.tab')
#+END_SRC
...
#+BEGIN_SRC python :return figfile :results file
  ...
  for m, alpha, label, c in zip(masks, alphas, labels, colors):
  ...
  for source in tab[m1]:
      ax.text(source['Rc'], source['R90'], f'{source["Seq"]}',
              fontsize=6, color='r', ha='center', va='center')
