...
*** More approximations to the shell shape
+ Circle: this works for \theta < 45\deg 
+ [-] Hyperbola/ellipse: still to do, should work better out to larger angles
  ...
  + [ ] R_{c}\prime/R_{0}\prime vs R_{0}\prime/D\prime
...
+ [ ] Small angle approximations to the CRW and modified CRW results
