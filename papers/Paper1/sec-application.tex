...
to avoid dependency with this parameter. In dashed lines, the \citep{Canto:1996} solution for two 
spherical, isotropic  interacting winds is shown, while in continuos lines we show the solution where the
weakest wind has a density distribution given by (\ref{eq:nprop})}
\label{fig:r-beta}
\end{figure}
