...
If we apply the \CRW{} formalism for a photoevaporated flow with density given by (\ref{eq:nprop}), we find that the solutions for equations (8) - (11) of \citep{Canto:1996} are the following:
...
\end{align}  
The solution for (\ref{eq:piz}) includes an incomplete elliptic integral of the second kind. Combining equations  (\ref{eq:dotprop}) to (\ref{eq:jdot}) with equation (6) of \CRW{}
