...
\begin{figure*}
\begin{tabular}{@{}c@{}c@{}c@{}}
  \includegraphics[width=0.33\linewidth]{../../read-shapes/LV-bowshocks-xyfancy-positionswill-177-341} & \includegraphics[width=0.33\linewidth]{../../read-shapes/Multi-Fit/samp00/LV-bowshocks-xyfancy-positionssamp00-177-341} &
  \includegraphics[width=0.33\linewidth]{../../read-shapes/Multi-Fit/samp01/LV-bowshocks-xyfancy-positionssamp01-177-341} \\
  \includegraphics[width=0.33\linewidth]{../../read-shapes/LV-bowshocks-xyfancy-positionswill-LV5} & \includegraphics[width=0.33\linewidth]{../../read-shapes/Multi-Fit/samp00/LV-bowshocks-xyfancy-positionssamp00-LV5} &
  \includegraphics[width=0.33\linewidth]{../../read-shapes/Multi-Fit/samp01/LV-bowshocks-xyfancy-positionssamp01-LV5} \\
  \includegraphics[width=0.33\linewidth]{../../read-shapes/LV-bowshocks-xyfancy-positionswill-168-328} & 
  \includegraphics[width=0.33\linewidth]{../../read-shapes/Multi-Fit/samp00/LV-bowshocks-xyfancy-positionssamp00-168-328} & \includegraphics[width=0.33\linewidth]{../../read-shapes/Multi-Fit/samp01/LV-bowshocks-xyfancy-positionssamp01-168-328}
\end{tabular}
\label{fig:char-radii-obs}
...
fraction of the marks, but always keeping at least four points. 177-341 is an example where the measurementsonly change very slightly from one variation to other. While with 168-328 the changes are a little more noticeable. LV4 is a case where the most external points are crucial
in the determination of the radius of curvature}
\end{figure*}
