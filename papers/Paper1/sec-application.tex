...
We measured the Characteristic radii in Orion Nebula proplyds from observations with the ACS camera from the Hubble Space Telescope (HST) using a lamp filter around $\lambda = 5007 \AA$. The proposal for these observations were done by  Jogee, S. in 2004 with calibration purposes but (he never published anything using expliciyly these observations). % We must check if this phrase should be included
Neverthless, as we are only interested in measure the geometric shape of bow shocks, these observations are more than enough.
...
this optimization has two variants: the first one with the restriction that the center of the circle must lie in the symmetry axis (y=0), and the second variation is with no restrictions. The figure (\ref{fig:radii-measures-example}) shows a representation of the metodology described. Initially we tried to measure the radii $(R_0,R_{90})$, but it wasn't possible due to the fact that the brightness of the shell decays rapidly towards the wings, and using $R_\theta$ where $60 \lesssim \theta < 0 $ is not so useful, because there is not a significant difference between $R_0$ and $R_\theta$. Instead, we introduced the radius of curvature after we realized how well the shell's marks fits into a circle for all the proplyds (see figure (\ref{fig:char-radii-obs})).

\begin{figure*}
\begin{tabular}{cc}
\includegraphics[width=0.4\linewidth]{LV-bowshocks-xyfancy-OIII3a-LV3} & \includegraphics[width=0.4\linewidth]{LV-bowshocks-xyfancy-onaxis-OIII3a-LV3} \\
\includegraphics[width=0.4\linewidth]{LV-bowshocks-xyfancy-OIII3a-LV4} & \includegraphics[width=0.4\linewidth]{LV-bowshocks-xyfancy-onaxis-OIII3a-LV4} \\
\includegraphics[width=0.4\linewidth]{LV-bowshocks-xyfancy-OIII3a-LV5} & \includegraphics[width=0.4\linewidth]{LV-bowshocks-xyfancy-onaxis-OIII3a-LV5} \\
\includegraphics[width=0.4\linewidth]{LV-bowshocks-xyfancy-OIII3a-167-328} & \includegraphics[width=0.4\linewidth]{LV-bowshocks-xyfancy-onaxis-OIII3a-167-328} \\
\includegraphics[width=0.4\linewidth]{LV-bowshocks-xyfancy-502epositions-177-341} & \includegraphics[width=0.4\linewidth]{LV-bowshocks-xyfancy-onaxis-502epositions-177-341}
\end{tabular}
