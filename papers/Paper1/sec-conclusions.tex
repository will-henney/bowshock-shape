...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{figs/shape-conic-plot-M16-MS2070n00p10}
  \caption{Departure function for simulation}
  \label{fig:sim-depart}
\end{figure}

The assumptions underlying the models of the previous section may
break down in various ways.  Most importantly, the shocked shell may not be thin.  
