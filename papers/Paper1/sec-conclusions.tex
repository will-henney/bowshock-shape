...
\begin{figure}
  ...
  \caption[]{Apparent projected apex distance of simulations.  Line
    ...
    for the blue square symbols have been adjusted for the correction
    factor discussed in footnote~\ref{fn:meyer-correction}.}
...
instead of a hydrodynamic bow shock, and also calculate the signature
in the planitude--alatude plane of oscillations in the bow shape, which
may be due to instabilities or a time-varying source.  In a third
paper, % \citep{Henney:2018b},
we apply our techniques to observational datasets for three different
classes of stellar bow shocks: OB stars, cool giants/supergiants, and
young stars in the extended Orion Nebula.  In a fourth paper,
