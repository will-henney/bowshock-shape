...
\begin{figure}
  ...
  \caption[]{Apparent projected shapes of simulations in the
    ...
    shape, with tick marks indicating 20 equal intervals in
    \(\abs{\sin i}\). The true planitude and alatude are marked by
...
with measurements\footnote{%
  ...
  tracing around the bow the ridge of minimum radius of curvature of
  the contours.} %
from post-processed infrared dust continuum maps \citep[\S~4.3
of][]{Meyer:2017a}, shown by open square symbols for \(i = \ang{30}\),
\ang{45}, and \ang{60}.
