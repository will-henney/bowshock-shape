...
\begin{figure}
  ...
  \caption[]{Apparent projected shapes of simulations in the
    ...
    \(\abs{\sin i}\). Open square symbols show the shapes traced from
    the dust emission maps at \SI{60}{\um} for inclinations of
...
The resultant inclination-dependent tracks in the planitude--alatude plane are shown in 
