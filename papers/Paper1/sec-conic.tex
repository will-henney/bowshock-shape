...
\begin{figure*}
  ...
  \caption[]{Effects of projection on quadrics of revolution:
    variation with inclination of characteristic radii. In panels
    (a)--(c), vertical rectangles show quartiles of \(|\sin i|\), which
    will be equally populated for an isotropic distribution of
