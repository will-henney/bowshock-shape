...
\begin{figure*}
  ...
  \caption[]{As Figure~\ref{fig:quadric-projection}, but
    (a)~projected/true star-apex distance: \(R_0' / R_0\), \(i\), and
    (b)~diagnostic planitude--alatude diagram: \(\Lambda'\) versus
    \(\Pi'\).  Shading indicates different classes of quadrics:
...
Figure~\ref{fig:quadric-projection-continued}a shows how the apparent
