...
Due to the similarities between the parametrization of the ellipse and the hyperbola, we can
do the following parametrization\footnote{The wholee formalism descripted in this section does
  not apply for paraboloids ($\theta_c=0$ case). This case is developed in appendix
  \ref{app:parabola}}:
\begin{align}
