...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{figs/projected-Tc-vs-Rc}
  \caption{Diagnostic diagram for projected quadric parameters}
  \label{fig:projected-Tc-vs-Rc}
\end{figure}
\begin{figure*}
  \centering
  \includegraphics[width=\linewidth]{figs/projected-Tc-Rc-snapshots.png}
  \caption{Variation with inclination angle of projected quadric parameters}
  \label{fig:projected-Tc-Rc-snapshots}
\end{figure*}
