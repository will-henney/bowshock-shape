...
\subsection{Parameters to characterize a bow shape}
...
required.  To efficiently capture the diversity of bow shapes, we propose the parameters shown in Figure~\ref{fig:characteristic-radii}. 

\(R_{90}\) has been used before \citep{Robberto:2005, Meyer:2016a}, but as far as we know \(R_c\) hasn't. 
