...
\begin{figure}
  ...
  \begin{tabular}{@{}ll@{}}
    (a) & (b) \\
    \includegraphics[height=0.8\linewidth]{figs/mipsgal-boxplot-Rc-R90-versus-R0}
    & \includegraphics[height=0.8\linewidth]{figs/mipsgal-boxplot-Rc-R90-versus-H0}
  \end{tabular}
  \caption{(a) Box plots of the distributions of bow shock shape
    parameters, \(R_c/R_0\) and \(R_{90} / R_0\), after partitioning
    on the bow shock size, \(R_0\).  All 3-, 4-, and 5-star sources
    are sorted according to \(R_0\) and divided into 5 non-overlapping
    ...
    The colored boxes show the interquartile range, with the median
    indicated by a horizontal line, the 1st-to-9th interdecile range
    by error bars, and outliers by diamonds.  It is apparent that the
    dispersion in \(R_{90} / R_0\) (upper panel) increases
