...
\item We test if there is any statistically significant difference
  between the shape distributions of the sub-samples by applying the
  2-sample Anderson--Darling test \citep{Anderson:1952a, Scholz:1987a} to the
  \(R_c/R_0\) and \(R_{90}/R_0\) distributions separately.  This is a
  non-parametric test of the \textit{null hypothesis} that the two
  sub-samples are drawn from the same distribution. 
