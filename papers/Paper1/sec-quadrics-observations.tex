...
\begin{figure*}
  ...
  \includegraphics{figs/alphaori-imageplot}
  \includegraphics{figs/mucep-imageplot}
  \includegraphics{figs/rhya-imageplot}
  \includegraphics{figs/rleo-imageplot}
  \includegraphics{figs/uuaur-imageplot}
  \includegraphics{figs/v1943sgr-imageplot}
  \includegraphics{figs/xpav-imageplot}
  \caption{RSG and AGB shells observed with Herschel}
