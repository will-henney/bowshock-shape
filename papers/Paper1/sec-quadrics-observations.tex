...
\begin{figure*}
  ...
  \begin{tabular}{ll}
    (a) & (b) \\
    \includegraphics[width=0.45\textwidth]{figs/mipsgal-Rc-R90-zoom-annotated} &
  ...
  \caption[]{MIPSGAL sources on the bow shock shape diagnostic diagram
    ...
    directions.  (b) Kernel density estimate of the distribution for
    3-star sources (blue, filled contours) and 4- plus 5-star sources
    (orange/brown, unfilled contours).  Images of representative 4-
    and 5-star sources at different points on the \(R_c\)--\(R_{90}\)
