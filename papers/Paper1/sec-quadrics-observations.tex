...
\begin{figure}
  \centering
  \includegraphics[width=0.7\linewidth]{figs/mipsgal-boxplot-Rc-R90-versus-R0}
  \caption{Box plots of the distributions of bow shock shape
    parameters, \(R_c/R_0\) and \(R_{90} / R_0\), as a function of bow
    shock size, \(R_0\).  All 3-, 4-, and 5-star sources are sorted
