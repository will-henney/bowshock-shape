...
there to be multiple candidates for identity of the central star that
drives the bow shock.  If the central star were to be misidentified,
then the measured value of \(R_0\) would be erroneous, which would
increase the dispersion in both \(R_c/R_0\) and \(R_{90}/R_0\).  The
