...
inner wind is developed in Appendix~\ref{app:ancantoid}, giving rise
to what we call \textit{ancantoids}, which depend on an anisotropy
index, \(k\), in addition to \(\beta\).  The resulting shapes are shown in
...
increasing \(\beta\), but at a given \(\beta\) it is the cantoid (black lines) that is most open
