...
and~\ref{fig:projected-R90-Rc-snapshots}.  The \(k=0\) ancantoid is
identical to the cantoid for \(\theta \le 90^\circ\) (\(z > 0\)), but is slightly
more swept back in the far wings.\footnote{%
  Due to the discontinuity in the inner wind density at
  \(theta = 90^\circ\) (see Fig.~\ref{fig:anisotropic-arrows}), there is a
...
Figure~\ref{fig:ancantoid-Pi-lambda-true}, which lies in the prolate
ellipsoid region of the plane.  
