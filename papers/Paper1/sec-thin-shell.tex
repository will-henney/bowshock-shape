...
\begin{figure*}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/test_xyprime}
...
\begin{figure*}
  \centering
  \includegraphics[width=0.9\linewidth]{figs/test_xyprime_ancantoid}
...
\(\abs{i} = 60^\circ\), at which point they open up again.
