...
% OR
[Bow shocks, bow waves, and dust waves. VII.]
{\boldmath Bow shocks, bow waves, and dust waves. VII. The runaway O~star AE~Aurigae ploughs into the Galactic disk}
% OR
% {\boldmath AE Aurigae: an O star ploughs into the Galactic disk}
...
\maketitle
\begin{abstract}
  Is it a dust wave or is it a bow shock?
\end{abstract}
...
One of the highest proper motions of any O star - see Fig~1 of \citet{Moffat:1998a}
...
\begin{figure*}
  \centering
  \includegraphics[width=\linewidth]{figs/ae-aur-combo-mir}
  \caption{AE~Aur in context. }
  \label{fig:aeaur}
\end{figure*}
