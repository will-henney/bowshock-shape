...
\begin{abstract}
  ...
  sample of 23 mid-infrared bow-shaped sources, we identify 4 strong
  candidates for radiation-supported bow waves, which need to be
  confirmed by more detailed studies, but no strong candidates for
  dust waves.
\end{abstract}
