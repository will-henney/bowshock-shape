...
small\footnote{%
  ...
  effects on \(\Lambda_+'\) and \(\Lambda_-'\), which cancel out in \(\langle\Lambda'\rangle\).
} %
...
\(\Lambda'\) are appropriate when analyzing observations of a similar
quality to those presented in Figure~\ref{fig:000-400-fit}.
