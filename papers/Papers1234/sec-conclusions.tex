...
is of the same order as \(R_0\). 

We have traced the the shape of the contact discontinuity in the two
models, using the procedure outlined in Figure~\ref{fig:meyer-trace}.

The parabolic departure function
