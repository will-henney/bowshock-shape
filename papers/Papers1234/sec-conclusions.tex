...
\begin{figure*}
  ...
  \caption[]{Example empirical determination of planitude and alatude
    ...
    \textit{b} and \textit{c} the iterations converge immediately, but
    in panel \textit{a} the iterations stably oscillate between two
...
real bow shock, in Figure~\ref{fig:000-400-fit} we present an analysis
of the H\(\alpha\) emission arc associated with the proplyd M42~000-400 in
the west of the Orion Nebula \citep{Bally:2000a},\footnote{%
...
tracings of the bow shape are considered: the peak of the emission arc
(``ridge''), and its inner and outer edges
(Fig.~\ref{fig:000-400-fit}\textit{a}--\textit{c}).  In all three
