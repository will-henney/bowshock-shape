...
\(\Lambda_+'\), may be different.  We calculate an average alatude,
\(\langle\Lambda'\rangle\), and an alatude asymmetry, \(\Delta\Lambda'\):
\begin{equation}
...
\end{equation}
The results for these and the planitude are shown in Table~\ref{tab:m42-fit}
