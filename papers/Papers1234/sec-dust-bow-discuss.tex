...
(App.~\ref{app:bow-shock-data}, eq.~[\ref{eq:total-ir-flux}]), giving
a standard deviation of 17\% (0.07~dex).\footnote{%
  The absolute flux calibration uncertainty for both Herschel PACS
...
\begin{figure*}
  ...
  \caption{Wind mass-loss rates as a function of stellar luminosity,
    derived from (a)~our momentum efficiency method and (b)~the grain
    emissivity method of \citet{Kobulnicky:2018a}, with corrections as
    described in Appendix~\ref{app:bow-shock-data}.  Circle symbols
    show the sources from K18, colored according to the stellar
    effective temperature (see key at far right). }
