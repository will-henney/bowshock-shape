...
\begin{equation}
  \label{eq:dcool}
  d\cool = \frac{P_1 v_1} { (\gamma - 1) \bigl(  \mathcal{L}_1 - \mathcal{G}_1 \bigr) }\ ,  
\end{equation}
...
In Figure~\ref{fig:zones-v-n-plane} we show curves corresponding to
\(d\cool = R_0\) and \(d\cool = h_0\), where \(h_0\) is the shell
thickness in the efficient cooling case.  
