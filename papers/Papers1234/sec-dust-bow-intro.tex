...
\begin{figure}
  ...
  \caption{As Fig.~\ref{fig:zones-v-n-plane}, but for an evolved
    ...
    to Fig.~\ref{fig:zones-v-n-plane} in all respects, except the
    trapping of the ionization front, which occurs for much lower
    outer stream densities.}
...
relatively stronger for this star tan for the main-sequence stars, but
even for \(v_{10} < 2\), where the effect is strongest, the change is
only of order the width of the red line in
