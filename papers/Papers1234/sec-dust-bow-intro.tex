...
\end{equation}
where we have made use of equations~\eqref{eq:Rstar} and~\eqref{eq:Xi-Prad-over-Pgas}. 
...
\subsubsection{Dust waves in stream parameter space}
\label{sec:dust-waves-stream}
