...
wave arises.  Only for \(n > \SI{e3}{cm^{-3}}\) does \(R_{\text{dfbs}}\) begin
to curve up from the general \(n^{-1/2}\) trend, becoming essentially
flat until the full-coupling point at \(n \approx \SI{3e4}{cm^{-3}}\)
