...
classes of bow shock source.  The remainder of the paper is organized as follows: in \S~\ref{sec:mid-infrared-arcs} we present an analysis of the shapes of several hundred bowshock candidates associated with OB stars from the 
