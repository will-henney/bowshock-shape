...
uncertainties in \(\eta\shell\) and \(\tau\) mean that the mass loss will be
poorly constrained in such a case.

Resulting mass-loss rates are shown as a function of stellar
luminosity in Figure~\ref{fig:mass-loss-vs-luminosity}a for the K18 and
Orion sources.
