\section{A simple model for stellar bow shells}
...
The stellar bow shells modeled in this paper can be seen as either due to
...
In \S~\ref{sec:depend-stell-type} we found that the bow shell is
