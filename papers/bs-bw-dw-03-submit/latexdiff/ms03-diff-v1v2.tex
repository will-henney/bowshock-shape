...
%DIF DEL ms03-v1-expand.tex   Sat Jun 22 20:19:10 2019
%DIF ADD ms03-v2-expand.tex   Sat Jun 22 20:19:10 2019
...
\providecommand{\DIFdeltex}[1]{{\protect\color{white!50!black} \ifmmode\cancel{#1}\else\sout{#1}\fi}} %DIF PREAMBLE
...
of Paper~I).  \DIFdelbegin \DIFdel{But the }\DIFdelend \DIFaddbegin \DIFadd{On the other hand, the }\DIFaddend same photons also heat the dust
...
star, then \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{an absorption }\DIFaddend optical depth can be estimated as
...
density, \(\rho\), \DIFdelbegin \DIFdel{relative
velocity \(v_\infty\)}\DIFdelend \DIFaddbegin \DIFadd{stream--star relative velocity \(v\)}\DIFaddend , and effective
...
\SI{e4}{L_\odot}}%DIFAUXCMD
\bigr) }\\
  \DIFadd{v_{10} }&\DIFadd{= v / \bigl( \mbox{%DIFAUXCMD
\SI{10}{km.s^{-1}} }%DIFAUXCMD
\bigr) }\\
...
disruption of larger grains \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{Hoang:2018a}}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Hoang:2019b}}%DIFAUXCMD
}\DIFaddend .
...
\item A significant fraction of the shock energy must be radiated by
  ...
  \DIFdelbegin \DIFdel{\(v_\infty > \SI{200}{km.s^{-1}}\) }\DIFdelend \DIFaddbegin \DIFadd{\(v > \SI{200}{km.s^{-1}}\) }\DIFaddend \citep{Draine:1981a}.  This also
...
will consider it in detail.  The kinetic energy flux through the outer shock for an ambient stream of density \DIFdelbegin \DIFdel{\(\rho_\infty\) and velocity \(v_\infty\) is
}\begin{displaymath}
  \DIFdel{%DIFDELCMD < \label{eq:Fkin}%%%
  F\ke = \tfrac12 \rho_\infty v_\infty^3 = \tfrac12 P\shell v_\infty \ , 
}\end{displaymath}
%DIFAUXCMD
\DIFdelend \DIFaddbegin \DIFadd{\(\rho\) and velocity \(v\) is
}\begin{equation}
  \DIFadd{\label{eq:Fkin}
  F\ke = \tfrac12 \rho v^3 = \tfrac12 P\shell v \ , 
}\end{equation}
\DIFaddend while the stellar radiative energy flux absorbed by the shell is
\begin{equation}
  \label{eq:Ftrap}
...
\DIFdelbegin \begin{displaymath}
  \DIFdel{%DIFDELCMD < \label{eq:F-ratio-shock}%%%
  \frac{F\ke}{F\trap} = \frac12 \frac{\eta\wind}{\tau} \frac{v_\infty}{c} \ .
}\end{displaymath}
%DIFAUXCMD
\DIFdelend \DIFaddbegin \begin{equation}
  \DIFadd{\label{eq:F-ratio-shock}
  \frac{F\ke}{F\trap} = \frac12 \frac{\eta\wind}{\tau} \frac{v}{c} \ .
}\end{equation}
\DIFaddend An upper limit to the stellar wind momentum efficiency \(\eta\wind\) is
...
a stream velocity \DIFdelbegin \DIFdel{\(v_\infty = \SI{200}{km.s^{-1}}\)}\DIFdelend \DIFaddbegin \DIFadd{\(v = \SI{200}{km.s^{-1}}\)}\DIFaddend , we have
\(F\ke/F\trap < 0.01\) and the shock-excited dust emission is still
negligible.  Only in stars with \DIFdelbegin \DIFdel{\(v_\infty > \SI{1000}{km.s^{-1}}\) }\DIFdelend \DIFaddbegin \DIFadd{\(v > \SI{1000}{km.s^{-1}}\) }\DIFaddend would
...
%DIFDELCMD <   \centering
%DIFDELCMD <   \includegraphics[width=\linewidth]{figs/K18-emissivity-vs-U}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIF >    \centering
%DIF >    \includegraphics[width=\linewidth]{figs/K18-emissivity-vs-U}
...
\citep[RATD;][]{Hoang:2018a}}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep[RATD;][]{Hoang:2019b}}%DIFAUXCMD
...
critical size given in equation~(28) of \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citet{Hoang:2018a}}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citet{Hoang:2019b}}%DIFAUXCMD
}\DIFaddend , as we
...
sharing results in advance of publication \DIFdelbegin \DIFdel{.
}\DIFdelend \DIFaddbegin \DIFadd{and Thiem Hoang for useful
...
\DIFdelbegin %DIFDELCMD < \bibitem[\protect\citeauthoryear{{Hoang}, {Tram}, {Lee}  \& {Ahn}}{{Hoang}
%DIFDELCMD <   et~al.}{2018}]{Hoang:2018a}
%DIFDELCMD < {Hoang} %%%
\DIFdelend \DIFaddbegin \bibitem[\protect\citeauthoryear{Hoang, Tram, Lee  \& Ahn}{Hoang
  et~al.}{2019}]{Hoang:2019b}
\DIFadd{Hoang }\DIFaddend T.,  \DIFdelbegin %DIFDELCMD < {%%%
\DIFdel{Tram }%DIFDELCMD < } %%%
\DIFdelend \DIFaddbegin \DIFadd{Tram }\DIFaddend L.~N.,  \DIFdelbegin %DIFDELCMD < {%%%
\DIFdel{Lee }%DIFDELCMD < } %%%
\DIFdelend \DIFaddbegin \DIFadd{Lee }\DIFaddend H.,   \DIFdelbegin %DIFDELCMD < {%%%
\DIFdel{Ahn }%DIFDELCMD < } %%%
\DIFdelend \DIFaddbegin \DIFadd{Ahn }\DIFaddend S.-H.,  \DIFdelbegin \DIFdel{2018, arXiv, }%DIFDELCMD < \href
%DIFDELCMD <   {http://adsabs.harvard.edu/abs/2018arXiv181005557H} {}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{2019, }\mn\DIFadd{@doi }[\DIFadd{Nature Astronomy}]
  {\DIFadd{10.1038/s41550-019-0763-6}}\DIFadd{, }\href
