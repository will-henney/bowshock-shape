...
%DIF DEL ms-bows01-expand.tex   Wed Mar  7 12:48:13 2018
%DIF ADD ms-bows02-expand.tex   Wed Mar  7 12:48:13 2018
...
\citealp{Robberto:2005, Cox:2012a, Meyer:2016a}}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citealp{Robberto:2005a, Cox:2012a, Meyer:2016a}}%DIFAUXCMD
}\DIFaddend ), but as far as we
know, we are the first to include \(R_{\C}\).  \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citet{Robberto:2005}
}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citet{Robberto:2005a}
}%DIFAUXCMD
}\DIFaddend \S~4.2 use the ratios \(R_0/D\) and \(R_{90}/D\) in analyzing proplyd
...
\begin{equation}
  ...
  \tan\theta' = y'\T / x'\T.
\end{equation}
\DIFdelbegin \DIFdel{Note that equation}\DIFdelend \DIFaddbegin 

\DIFadd{Equation}\DIFaddend ~(\ref{eq:tanphi}) will not have a solution for
...
\DIFaddbegin \DIFadd{After completing this work, it was brought to our attention that the
principal results of this section had already been derived in
Appendix~B of the PhD thesis \mbox{%DIFAUXCMD
\citet{Wilkin:1997a}}%DIFAUXCMD
.  For instance,
Wilkin's equation~(8) is equivalent (apart from differences in
notation) to our equation~}\eqref{eq:tanphi}\DIFadd{.
}

\DIFaddend \subsection{Characteristic radii on the plane of the sky}
...
ancantoids)\DIFaddbegin \footnote{%DIF > 
  \DIFadd{See also previous studies of the projected shape of the wilkinoid
  \mbox{%DIFAUXCMD
\citep{Wilkin:1997a, Cox:2012a, Ng:2017a} }%DIFAUXCMD
and the cantoids
  \mbox{%DIFAUXCMD
\citep{Robberto:2005a}}%DIFAUXCMD
.}} %DIF > 
\DIFaddend for different inclination angles \(\abs{i}\).  For comparison,
...
{Ng} \DIFadd{C.-Y.,  }{\DIFadd{Bandiera}} \DIFadd{R.,  }{\DIFadd{Hunstead}} \DIFadd{R.~W.,   }{\DIFadd{Johnston}} \DIFadd{S.,  2017, }\apj\DIFadd{,
  842, 100
}
...
\DIFdelbegin %DIFDELCMD < \bibitem[\protect\citeauthoryear{{Robberto} et~al.,}{{Robberto}
%DIFDELCMD <   et~al.}{2005}]{Robberto:2005}
%DIFDELCMD < {Robberto} %%%
\DIFdelend \DIFaddbegin \bibitem[\protect\citeauthoryear{{Ricci}, {Robberto}  \& {Soderblom}}{{Ricci}
  et~al.}{2008}]{Ricci:2008a}
{Ricci} \DIFadd{L.,  }{\DIFadd{Robberto}} \DIFaddend M.,   \DIFaddbegin {\DIFadd{Soderblom}} \DIFadd{D.~R.,  2008, }\aj\DIFadd{, 136, 2136
}

\bibitem[\protect\citeauthoryear{{Robberto} et~al.,}{{Robberto}
  et~al.}{2005}]{Robberto:2005a}
{Robberto} \DIFadd{M.,  }\DIFaddend et~al., 2005, \DIFdelbegin %DIFDELCMD < \mn%%%
\DIFdel{@doi }%DIFDELCMD < [%%%
\DIFdelend \aj\DIFdelbegin %DIFDELCMD < ] {%%%
\DIFdel{10.1086/428000}%DIFDELCMD < }%%%
\DIFdel{, }%DIFDELCMD < \href
%DIFDELCMD <   {http://adsabs.harvard.edu/abs/2005AJ....129.1534R} {129, 1534}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{, 129, 1534
}\DIFaddend 
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{Wilkin}}{{Wilkin}}{1997}]{Wilkin:1997a}
{Wilkin} \DIFadd{F.~P.,  1997, PhD thesis, University of California, Berkeley
}

\DIFaddend \bibitem[\protect\citeauthoryear{{Wilkin}}{{Wilkin}}{2000}]{Wilkin:2000a}
