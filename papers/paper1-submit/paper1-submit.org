...
The equation is correct, see for example Guggenheimer:2012a chapter 2.  There is no problem with the dimensions because theta is effectively dimensionless in this context when expressed in radians.   
